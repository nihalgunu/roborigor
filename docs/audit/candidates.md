...
Produced under the audit's fixed intake rules, before any inclusion
decisions or extraction. Sources: (1) arXiv abstract search for the four benchmarks,
...
applying the fixed inclusion criteria; the first 17/17/16 included
