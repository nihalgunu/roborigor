...
1. Share of recomputable highlighted comparisons with exact-test p > 0.05
   at the papers' own stated n: 27/86 = 31.4%.
   (Superseded 2026-08-24 by deviations-log Entry 16, which raised the
   Boschloo cap from min(n) <= 200 to 2000 and recomputed. The value
   computed at gate time on 2026-08-18, and logged in Entry 2, was
   28/86 = 32.6% under the old all-Fisher routing above n = 200.)
...
Clause 1 (>= 1/3 fail exact tests): 31.4% < 33.3%. NOT MET.
(Called on 2026-08-18 at 32.6%; the Entry 16 recomputation moves it to
31.4% and widens the margin. Verdict unchanged.)
