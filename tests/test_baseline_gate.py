...
ROBORIGOR_BASELINE_DIR points at it. Never hardcode a local path here.
"""
import json
import os
...
BASELINE = os.environ.get("ROBORIGOR_BASELINE_DIR")

pytestmark = pytest.mark.skipif(
    not BASELINE, reason="ROBORIGOR_BASELINE_DIR not set"
)
