...
```bash
# install (from PyPI, or from a clone of this repository)
pip install roborigor        # or: pip install -e .
...
| Recomputable comparisons that fail an exact test at the paper's own n | 31.4% (27/86) |
...
| Robustness cost of the single-step frontier under camera-viewpoint shift (pre-declared confirmatory sample, 838 paired draws) | 4.7 points (exact McNemar p=0.0008); non-inferior under layout shift |
