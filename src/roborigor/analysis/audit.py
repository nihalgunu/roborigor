"""Literature-audit recomputation.
...
# scipy implementation's runtime becomes prohibitive (about 74 s at n = 2000
...
def recompute(rows: list[dict], alpha: float = 0.05) -> dict:
    ...
    for row in rows:
        for c in row["comparisons"]:
            ...
            # Boschloo is the primary test and is enumerated wherever it terminates in
