...
cp "$ROOT"/paper/{main.tex,refs.bib,numbers.tex,table_grid.tex,table_power.tex,table_transfer.tex} "$OUT/"
...
tar czf arxiv_source.tar.gz main.tex main.bbl refs.bib numbers.tex \
    table_grid.tex table_power.tex table_transfer.tex figures/
